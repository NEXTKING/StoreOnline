...
@implementation NwobjectXReport
...
- (void) run: (NSString*) url
{
    ...
    nwReq.URL = [NSMutableString stringWithFormat:@"%@/xreport/%@/",url, uuid];
    //#endif
...
- (void) complete: (BOOL) isSuccessfull
{
    ...
    if ( _delegate && [_delegate respondsToSelector:@selector(xReportComplete:)])
        [_delegate xReportComplete:_resultCode];
}
