...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementSVARCHAR2CVS_VERSIONInput * SVARCHAR2_CVS_VERSIONInput;
...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementCTPORTIONINFOARRAYGET_PORTIONS_INFOInput * CTPORTIONINFOARRAY_GET_PORTIONS_INFOInput;
...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementSNUMBERPASTING_SAVE_PRINT_FACTInput * SNUMBER_PASTING_SAVE_PRINT_FACTInput;
...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementSNUMBERPASTING_SET_TASK_DONEInput * SNUMBER_PASTING_SET_TASK_DONEInput;
...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementSVARCHAR2RESET_INC_DONEInput * SVARCHAR2_RESET_INC_DONEInput;
...
@property(nonatomic, strong) PI_MOBILE_SERVICEService_ElementSVARCHAR2SET_INC_DONEInput * SVARCHAR2_SET_INC_DONEInput;
